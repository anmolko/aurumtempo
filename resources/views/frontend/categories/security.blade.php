                ...
                <div class="inner-container clearfix">
                    ...
                    <div class="page-nav">
                        <ul class="bread-crumb clearfix">
                            <li><a href="/">Home</a></li>
                            <li class="active">Security & Guarding</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="content-side col-lg-8 col-md-12 col-sm-12">
                    <div class="service-details">
                        <div class="text-content">
                            <h3>Security & Guarding</h3>
                            <div class="main-image image">
                                <img src="{{asset('assets/images/category/security.png')}}" alt="Security & Guarding">
                            </div>
                            <div class="featured">
                                <div class="row clearfix">
                                    ...
                                    <div class="inner">
                                            ...
                                            <ul>
                                                <li>
                                                    Security Manager / Supervisor  / Guards
                                                </li>
                                                <li>
                    ...
                    <aside class="sidebar blog-sidebar">
                        ...
                        <div class="sidebar-widget services">
                            <div class="widget-inner">
                                ...
                                <ul>
                                    <li class="active"><a href="{{url('/security')}}">Security & Guarding</a></li>
